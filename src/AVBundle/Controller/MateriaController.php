...
use AVBundle\Entity\Materia;
use AVBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AVBundle:Materia')->findAll();

        return $this->render('AVBundle:Materia:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AVBundle:Materia:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AVBundle:Materia')->find($id);
        ...
        return $this->render('AVBundle:Materia:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AVBundle:Materia:edit.html.twig', array(
            'entity'      => $entity,
